...
function tpl_function_db_result_call($params, &$template_object)
{
	...
	{
		throw new Template_Exception("db_result_call: missing db_object parameter", $template_object);
	}

	if (!is_object($params['db_object']))
	{
		throw new Template_Exception("db_result_call: db_object isn't an object", $template_object);
	}
	...
	{
		throw new Template_Exception("db_result_call: missing db_result_object parameter", $template_object);
	}

	if (!is_object($params['db_result_object']))
	{
		throw new Template_Exception("db_result_call: db_result_object isn't an object", $template_object);
	}
	...
	{
		throw new Template_Exception("db_result_call: missing db_assign parameter", $template_object);
	}

	if (empty($params['db_function']))
	{
		throw new Template_Exception("db_result_call: missing db_function parameter", $template_object);
	}
