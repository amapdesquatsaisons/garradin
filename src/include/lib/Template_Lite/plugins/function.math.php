...
function tpl_function_math($params, &$template_object)
{
	...
	{
        throw new Template_Exception("math: missing equation parameter", $template_object);
        return;
    }
	...
	{
        throw new Template_Exception("math: unbalanced parenthesis", $template_object);
        return;
    }
    ...
    foreach($match[0] as $curr_var)
	{
		...
		{
            throw new Template_Exception("math: parameter $curr_var not passed as argument", $template_object);
            return;
        }
    }
